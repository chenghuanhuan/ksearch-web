    ...
    function(c) {
        ...
        b.prototype = {
            ...
            show: function() {
                ...
                d.input = c('<input type="text">').attr("placeholder", d.options.placeholder).insertAfter(d.element).on("focus",
                    function() {
                ...
                c(d.input.data("typeahead").$menu).on("mousedown",
                    function() {
                        d.skip = true
                    });
            ...
            createBadge: function(e) {
                ...
                c("<span/>", {
                    "class": "tag"
                }).text(e).append(c('<button type="button" class="close">&times;</button>').on("click",
                    function(t) {
                        var index = d.element.siblings(".tag").index(c(this).closest(".tag"));
                        var text = d.values[index];
                        d.remove(d.element.siblings(".tag").index(c(this).closest(".tag")));

                        d.options.afterRemove(text);
